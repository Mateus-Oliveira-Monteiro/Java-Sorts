...
public class JavasSortAula {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Tempo do Bubble Sort:"+tempo + " Comparacoes:"+ bsort.getComparacoes());
        ...
        tempo = tfinal - inicio;
        System.out.println("Tempo do Selection Sort:"+tempo + " Comparacoes:"+ssort.getComparacoes());
        ...
        tfinal = System.currentTimeMillis();
        tempo = tfinal - inicio;
        System.out.println("Tempo do Insertion Sort:"+tempo+ " Comparacoes:"+ isort.getComparacoes());
